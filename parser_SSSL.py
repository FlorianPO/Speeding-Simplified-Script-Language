...
__version__ = (2016, 4, 5, 20, 45, 35, 1)
...
class SSSLParser(Parser):
    ...
    def _DEFS_(self):
        ...
        self.ast._define(
            ['DOBJT', 'DMAIN', 'DFUNC', 'DECLAFF', 'DECL', 'AFF'],
            []
        )
    ...
    def _KEYW_(self):
        with self._choice():
            ...
            with self._option():
                self._token('false')
            self._error('expecting one of: Main and back class echo echoln false func or return true')
    ...
    def _t_EXPR_(self):
        ...
        self.ast._define(
            ['PARENTH', 'TRUE', 'FALSE', 'CFUNC', 'NAME', 'VAL'],
            []
        )
